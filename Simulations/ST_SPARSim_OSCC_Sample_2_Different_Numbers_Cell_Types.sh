...
R CMD BATCH --no-save --no-restore ST_SPARSim_OSCC_Sample_2_Different_Numbers_Cell_Types.R ./log/ST_SPARSim_OSCC_Sample_2_Different_Numbers_Cell_Types_$SLURM_ARRAY_TASK_ID.txt
